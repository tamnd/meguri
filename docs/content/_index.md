...
- Curious what is inside a partition? The [file format](/reference/file-format/) page documents the `.meguri` container, and the [CLI reference](/reference/cli/) covers the commands.
